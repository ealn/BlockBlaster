    ...
    <div id="body">
		<div id="content">
          ...
          <table border="0" cellpadding="0" cellspacing="0">
			...
			$resul = mysql_query("SELECT * FROM peliculas WHERE YEAR=$year", $link);
					...
					if ($pagi <> 0)  
{  
$pag_anterior = "<a href='buscar_por_year.php?year=$year&pagi=$prim_reg_ant'>Pagina anterior</a>"; 
} 
// ----------------------------- Pagina siguiente 
...
{  
$pag_siguiente = "<a href='buscar_por_year.php?year=$year&pagi=$prim_reg_sigu'>Pagina siguiente</a>"; 
} 
// ----------------------------- Separador 
...
// Si recibimos un valor por la variable $page ejecutamos esta consulta 
    ...
    $query = "SELECT * FROM peliculas WHERE YEAR=$year LIMIT $pagi,$numer_reg "; 
}  
else  
{  
// Si NO recibimos un valor por la variable $page ejecutamos esta consulta 

    $query = "SELECT * FROM peliculas WHERE YEAR=$year LIMIT 0,$numer_reg"; 
}  
...
"; 
				...
				/*
				$consulta = mysql_query("SELECT * FROM peliculas WHERE YEAR=$year", $link);
