...
<div id="container">
    ...
    <div id="nav">
    	<ul>
            ...
            <li><a  class="selected" href="actor.php">Actor</a></li>
    ...
    <div id="body">
		<div id="content">
          ...
          <table border="0" cellpadding="0" cellspacing="0">
            ...
            <?php
					$resul = mysql_query("SELECT * FROM peliculas p, actor_pelicula d WHERE p.ID_PELICULA=d.ID_PELICULA AND d.ID_PERSONAJE = $id_personaje", $link);
					...
					if ($pagi <> 0)  
{  
$pag_anterior = "<a href='buscar_por_actor.php?id=$id_personaje&pagi=$prim_reg_ant'>Pagina anterior</a>"; 
} 
// ----------------------------- Pagina siguiente 
...
{  
$pag_siguiente = "<a href='buscar_por_actor.php?id=$id_personaje&pagi=$prim_reg_sigu'>Pagina siguiente</a>"; 
} 
// ----------------------------- Separador 
...
// Si recibimos un valor por la variable $page ejecutamos esta consulta 
    ...
    $query = "SELECT * FROM peliculas p, actor_pelicula g WHERE p.ID_PELICULA=g.ID_PELICULA AND g.ID_PERSONAJE = $id_personaje LIMIT $pagi,$numer_reg "; 
}  
else  
{  
// Si NO recibimos un valor por la variable $page ejecutamos esta consulta 

    $query = "SELECT * FROM peliculas p, actor_pelicula g WHERE p.ID_PELICULA=g.ID_PELICULA AND g.ID_PERSONAJE = $id_personaje LIMIT 0,$numer_reg"; 
}  
