...
<div id="container">
    ...
    <div id="nav">
    	<ul>
            ...
            <li><a  class="selected" href="genero.php">Genero</a></li>
    ...
    <div id="body">
		<div id="content">
			<h2><?PHP 
				$ge= mysql_query("SELECT * FROM genero WHERE ID_GENERO=$id_genero", $link);
          ...
          <table border="0" cellpadding="0" cellspacing="0">
            ...
            <?php
					$resul = mysql_query("SELECT * FROM peliculas p, genero_pelicula g WHERE p.ID_PELICULA=g.ID_PELICULA AND ID_GENERO = $id_genero", $link);
					...
					if ($pagi <> 0)  
{  
$pag_anterior = "<a href='buscar_por_genero.php?id=$id_genero&pagi=$prim_reg_ant'>Pagina anterior</a>"; 
} 
// ----------------------------- Pagina siguiente 
...
{  
$pag_siguiente = "<a href='buscar_por_genero.php?id=$id_genero&pagi=$prim_reg_sigu'>Pagina siguiente</a>"; 
} 
// ----------------------------- Separador 
...
// Si recibimos un valor por la variable $page ejecutamos esta consulta 
    ...
    $query = "SELECT * FROM peliculas p, genero_pelicula g WHERE p.ID_PELICULA=g.ID_PELICULA AND ID_GENERO = $id_genero LIMIT $pagi,$numer_reg "; 
}  
else  
{  
// Si NO recibimos un valor por la variable $page ejecutamos esta consulta 

    $query = "SELECT * FROM peliculas p, genero_pelicula g WHERE p.ID_PELICULA=g.ID_PELICULA AND ID_GENERO = $id_genero LIMIT 0,$numer_reg"; 
}  
